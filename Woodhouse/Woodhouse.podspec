...
Pod::Spec.new do |s|
  s.name             = "Woodhouse"
  s.version          = "0.1.0"
  s.summary          = "A short description of Woodhouse."
...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/Woodhouse"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Gabriel Coman" => "dev.gabriel.coman@gmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/Woodhouse.git", :tag => s.version.to_s }
